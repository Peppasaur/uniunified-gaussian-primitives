...
void renderScene(float* d_positions, float* d_orientations, float* d_scales,float* d_covs,float* magnitude,float* albedo,BoundingBox* d_bboxes,int N,KDNode* d_nodes,int max_depth,int max_bound,
int res,int focal,float* rgbs,float* env_rgbs,float* view_mat,float tanfovx,float tanfovy);
int rua();
